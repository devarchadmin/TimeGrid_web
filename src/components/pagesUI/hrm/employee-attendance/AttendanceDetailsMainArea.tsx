...
const AttendanceDetailsMainArea: React.FC<AttendanceDetailsMainAreaProps> = ({ id }) => {
  ...
  // Year selection options (current year and previous year)
  ...
  const leaveCount = Object.values(employee).filter(value => value === "On Leave").length;
            ...
            <div className="card__header">
              ...
              <div className="card__header-action">
                <div className="flex gap-4">
                  ...
                  <FormControl variant="outlined" className="min-w-[100px]">
