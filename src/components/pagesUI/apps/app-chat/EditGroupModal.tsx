...
const EditGroupModal: React.FC<EditGroupModalProps> = ({ chatInfo, onClose }) => {
  ...
  const [groupIcon, setGroupIcon] = useState<string>(chatInfo.image || './assets/images/logo/GW-Fav.svg');
  ...
  return (
    <div className="fixed inset-0 w-screen h-screen z-[110] flex items-center justify-center bg-black bg-opacity-50">
